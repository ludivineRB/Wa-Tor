...
while len(list_of_fish) != 0 or len(list_of_sharks)!=0:
    ...
    data.update_csv(chronon, number_of_fish, number_of_sharks, average_age_fish, average_age_shark, 
                    average_nb_descendants_fish, average_nb_descendants_shark, average_distance_fish, average_distance_shark
